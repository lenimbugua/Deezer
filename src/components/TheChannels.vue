      ...
      <li class="flex">
        <a class="group flex items-center" aria-label="Spotify" href="/"
          ...
          >
            ...
            ></path></svg
          ><span class="hidden sm:ml-3 sm:block">Spotify</span></a
        >
      </li>
      <li class="flex">
        <a class="group flex items-center" aria-label="Apple Podcast" href="/"
          ...
          >
            ...
            ></path></svg
          ><span class="hidden sm:ml-3 sm:block">Apple Podcast</span></a
        >
      </li>
      <li class="flex">
        <a class="group flex items-center" aria-label="Overcast" href="/"
          ...
          >
            ...
            ></path></svg
          ><span class="hidden sm:ml-3 sm:block">Overcast</span></a
        >
      </li>
      <li class="flex">
        <a class="group flex items-center" aria-label="RSS Feed" href="/"
          ...
          >
            ...
            ></path></svg
          ><span class="hidden sm:ml-3 sm:block">RSS Feed</span></a
        >
      </li>
    </ul>
  </section>
