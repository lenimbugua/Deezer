    ...
    >
      ...
      >
        ...
        <div class="flex justify-between gap-6">
          ...
          <div
            role="group"
            id="react-aria8757060281-1"
            aria-labelledby="react-aria8757060281-2"
            class="absolute inset-x-0 bottom-full flex flex-auto touch-none items-center gap-6 md:relative"
          >
            <label class="sr-only" id="react-aria8757060281-2"
              >Current time</label
            >
            <div
            ...
            >
              ...
              ></div>
              <div class="absolute top-1/2 -translate-x-1/2" style="left: 100%">
                <div
                ...
                >
                  ...
                  >
                    <input
                      ...
                      aria-valuetext="0 hours, 1 minute, 4 seconds"
                      value="64"
                    />
                  </div>
                </div>
